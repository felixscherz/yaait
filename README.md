...
Percentage quotas in the human report use the singular unit, such as
...
| Codex | 5-hour and weekly limits, reset times, and credits | [Codex](docs/providers/codex.md) |
